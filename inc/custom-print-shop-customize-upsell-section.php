 ...
 */
/**
 * Class Custom_Print_Shop_Customizer_Upsell_Section
 */
class Custom_Print_Shop_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * Custom_Print_Shop_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Custom_Print_Shop_Customizer_Upsell_Section' );
