...
if ( ! class_exists( 'Custom_Print_Shop_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Custom_Print_Shop_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'custom_print_shop_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function custom_print_shop_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Custom_Print_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'custom_print_shop_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function custom_print_shop_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Custom_Print_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
